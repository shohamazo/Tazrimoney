                    ...
                    <div className="text-right">
                     ...
                     <div className="text-right">
                        ...
                        <div className="mt-2 space-y-2">
                            <div className="flex items-center justify-end"><Label htmlFor="sub-tv" className="mr-2">שירותי סטרימינג (נטפליקס, דיסני+)</Label><Checkbox id="sub-tv" checked={subscriptions.includes('tv')} onCheckedChange={() => handleSubscriptionChange('tv')} className="ml-2"/></div>
                            <div className="flex items-center justify-end"><Label htmlFor="sub-music" className="mr-2">מנוי מוזיקה (ספוטיפיי, אפל מיוזיק)</Label><Checkbox id="sub-music" checked={subscriptions.includes('music')} onCheckedChange={() => handleSubscriptionChange('music')} className="ml-2"/></div>
                            <div className="flex items-center justify-end"><Label htmlFor="sub-gym" className="mr-2">מנוי לחדר כושר</Label><Checkbox id="sub-gym" checked={subscriptions.includes('gym')} onCheckedChange={() => handleSubscriptionChange('gym')} className="ml-2"/></div>
                        </div>
                    </div>
